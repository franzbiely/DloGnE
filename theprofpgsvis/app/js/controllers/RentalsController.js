    ...
    function($rootScope, $scope, $http, $timeout, $stateParams, moment, FUNC, $state) {
        ...
        $scope.showResult = function(property_id, from_id_link) {
            ...
            if(typeof $scope.data_temps.include_zero !== 'undefined' && $scope.data_temps.include_zero.id !== '') {
                $scope.searchdata.include_rentals_zero = $scope.data_temps.include_zero;
            }
            ...
            var form = '<form id="frmRental" name="frmRental" role="form" class="form-horizontal">\
                            <div class="form-body">\
                                ...
                                <div class="form-group">\
                                    ...
                                    <div class="col-md-7">\
                                        <div class="input-icon right">\
                                            <span class="form-control border border-white">' + FUNC.smart_number($scope[plural][key].analysed_rent, false) + '</span>\
                                        </div>\
                                    </div>\
                                </div>\
                                <div class="form-group">\
