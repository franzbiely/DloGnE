...
angular.module('MetronicApp').controller('UsersController', function($rootScope, $scope, settings, $http, $compile, $rootScope, FUNC) {
    ...
    // Delete - This feature is depcricated since we want the keep the integrity of the property data in the database that are connected from the user table.
    // instead use setDisable / setEnable feature.
    /*
