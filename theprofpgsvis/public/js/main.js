...
MetronicApp.factory('settings', ['$rootScope', function($rootScope) {
    ...
    if( app_config.env == 'stage' ) {
        ...
        $rootScope.apiURL = 'http://theprofessionals.local/api/';
        $rootScope.apiPublicURL = 'http://theprofessionals.local/';
    }
...
MetronicApp.config(['$stateProvider', '$urlRouterProvider', '$authProvider', function($stateProvider, $urlRouterProvider, $authProvider) {
    ...
    if(app_config.env == 'stage') {
        ...
        $authProvider.loginUrl = 'http://theprofessionals.local/api/authenticate';
    }
    ...
    $stateProvider
        ...
        .state("sales.preview", {
            url: "/preview/:sales_id/:property_id",
            views: {
                'app-body-inner': {
                    templateUrl: "views/sales/sales-preview.html",
