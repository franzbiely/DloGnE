...
Route::post('/pdf_fixer/fix', 'PDFFixerController@applyFix');
Route::get('/pdf_fixer/get/media', 'PDFFixerController@getBrokenMedia');
Route::get('/pdf_fixer/get/valuation', 'PDFFixerController@getBrokenValuation');
Route::resource('/pdf_fixer', 'PDFFixerController');
...
Route::group(['middleware' => 'cors', 'prefix' => 'api/v1'], function(){
	...
	Route::get('property/search/{property_id}', 'PropertiesController@search');
	...
	Route::resource('rental_inclusion_tier', 'RentalInclusionTiersController');
	Route::resource('rental_rating_tier', 'RentalRatingTiersController');
});
